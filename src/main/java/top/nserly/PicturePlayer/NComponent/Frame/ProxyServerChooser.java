...
public class ProxyServerChooser extends JDialog {
    ...
    private final JButton ChooseThisProxyServerButton;
    private final JButton AddProxyServerButton;
    private final JButton EditProxyServerButton;
    private final JButton DeleteProxyServerButton;
    private final JButton CancelProxyServerButton;
    private final JButton RefreshProxyServerButton;
    private final JTable ProxyServerTable;
    // 表格的数据模型
