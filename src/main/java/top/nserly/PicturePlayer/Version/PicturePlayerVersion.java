...
public class PicturePlayerVersion {
     ...
     */
    @Getter
    private static final String version = "V1.0.0.20260621_Release";
    @Getter
    private static final String ShorterVersion = "V1.0.0_Release";
    @Getter
    private static final String VersionID = "1500";
    @Getter
    private static final String BuildVersion = "Build2026.06.21.114352";
