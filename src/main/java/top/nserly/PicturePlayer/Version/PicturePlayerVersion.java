...
public class PicturePlayerVersion {
     ...
     */
    @Getter
    private static final String version = "V1.0.0.20250707_Beta";
    @Getter
    private static final String ShorterVersion = "V1.0.0_Beta";
    @Getter
    private static final String VersionID = "1305";
    @Getter
    private static final String BuildVersion = "Build2025.07.07.0000000023";
